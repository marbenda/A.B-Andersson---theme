...
<main>
    ...
    <section class="container py-5 mt-5">
        <div class="row g-5">
            <div class="col-lg-8">
                <div class="analogy-quote-box mb-5 overflow-hidden">
                    <blockquote class="blockquote mb-0 position-relative">
                        ...
                        <footer class="mt-4 d-flex align-items-center gap-3">
                            ...
                            <span class="small fw-bold text-primary text-uppercase" style="letter-spacing: 0.08em;">Princip Stavebního Dozoru</span>
                        </footer>
                    </blockquote>
                </div>
            ...
            <aside class="col-lg-4">
                <div class="sticky-top sticky-offset-100" style="top: 100px; z-index: 10;">
